...
HEMI_DIR="/root/heminetwork_v0.7.0_linux_amd64"
DOWNLOAD_URL="https://github.com/hemilabs/heminetwork/releases/download/v0.7.0/heminetwork_v0.7.0_linux_amd64.tar.gz"
...
Environment=POPM_STATIC_FEE=2200
